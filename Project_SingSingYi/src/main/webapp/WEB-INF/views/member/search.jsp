		...
		<div class="section" id="section0">
			<div class="start">
				...
				<div class="main-login main-center">
					<form class="form-horizontal" method="post" action="/member/search">
						<div class="form-group">
							<label class="cols-sm-2 control-label">비밀번호 찾고자 할 아이디</label>
						...
						<div class="form-group">
							<label class="cols-sm-2 control-label">비밀번호찾기 질문/답변</label>
							<div class="cols-sm-10">
								<div class="input-group">
						...
						<div class="form-group ">
							<button type="submit"
								class="btn btn-primary btn-lg btn-block login-button">찾기</button>
						</div>
